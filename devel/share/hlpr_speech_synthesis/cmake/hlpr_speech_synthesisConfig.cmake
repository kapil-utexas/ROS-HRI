...
if("TRUE" STREQUAL "TRUE")
  set(hlpr_speech_synthesis_SOURCE_PREFIX /home/caee-ks36732/catkin_ws/src/hlpr_speech/hlpr_speech_synthesis)
  set(hlpr_speech_synthesis_DEVEL_PREFIX /home/caee-ks36732/catkin_ws/devel)
  ...
  set(hlpr_speech_synthesis_INSTALL_PREFIX /home/caee-ks36732/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hlpr_speech_synthesis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caee-ks36732/catkin_ws/src/hlpr_speech/hlpr_speech_synthesis/${idir}'.  Ask the maintainer 'Baris Akgun <barisakgun@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hlpr_speech_synthesis_dep}_FOUND)
      find_package(${hlpr_speech_synthesis_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hlpr_speech_synthesis_dep} REQUIRED ${depend_list})
  endif()
